...
const heartBlust = () => {
    text.innerHTML = "😒 Lu itu siapa sih van cantik bangett, kalo dibilang cantik jangan ngeyel napa💔😭";
...
const heartArrange = () => {
  text.innerHTML = "kalau semua orang punya versi cantiknya masing2, versi cantikku jelas kamu wowwkkwkwkw";
  heartItem.forEach((item) => {
  ...
  setTimeout(() => {
    text.innerHTML =
      "Hehehe aku tanpamu bagaikan html tanpa css😂😂 Jangan Lupa Turu Cantik awok2😜";
  }, 5000);
};
